    ...
    <div className="stack gap-lg">
      ...
      <div className="footer__content">
        ...
        <div className="footer__socials">
          ...
          <a href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcSMScTSvvqdtBGWXlnDnQMXvvTFwRldKBtSZKmXMTlFDRqMGphQbTKmQjvbpDrNLMXwCbHQb" target="_blank" className="footer__icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
